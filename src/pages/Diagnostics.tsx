...
import { 
  Wifi, Monitor, Camera, ArrowRight, ArrowLeft, Terminal, 
...
const categories: Category[] = [
  {
    id: "internet",
    label: "אינטרנט איטי / בעיות רשת",
    icon: Wifi,
    questions: [
      {
        question: "מה קורה עם האינטרנט?",
        options: ["איטי מאוד", "מתנתק לפעמים", "לא עובד בכלל", "עובד רק ב-WiFi / רק בכבל"]
      },
      {
        question: "מתי התחילה הבעיה?",
        options: ["היום", "לפני כמה ימים", "אחרי שהחלפתי ראוטר/ספק", "תמיד היה ככה"]
      },
      {
        question: "כמה מכשירים מושפעים?",
        options: ["רק אחד", "כמה מכשירים", "כל המכשירים", "לא בטוח"]
      }
    ]
  },
  {
    id: "computer",
    label: "מחשב לא נדלק / תקוע",
    icon: Monitor,
    questions: [
      {
        question: "מה בדיוק קורה?",
        options: ["לא נדלק בכלל", "נדלק ונכבה", "מסך שחור", "תקוע על מסך טעינה", "מסך כחול (BSOD)"]
      },
      {
        question: "האם היה אירוע לפני התקלה?",
        options: ["הפסקת חשמל", "עדכון תוכנה", "נפל / נשפך נוזל", "לא, פתאום"]
      },
      {
        question: "האם יש נורות דולקות / רעש מאוורר?",
        options: ["כן, נורות דולקות", "כן, מאוורר עובד", "שניהם עובדים", "שום דבר לא קורה"]
      }
    ]
  },
  {
    id: "security",
    label: "מצלמות אבטחה / אזעקה",
    icon: Camera,
    questions: [
      {
        question: "מה הבעיה?",
        options: ["מצלמה לא מציגה תמונה", "תמונה מטושטשת", "אין גישה מרחוק", "ההקלטה לא עובדת"]
      },
      {
        question: "סוג המערכת?",
        options: ["מצלמות IP", "DVR אנלוגי", "NVR", "לא יודע"]
      },
      {
        question: "מתי הבעיה מתרחשת?",
        options: ["כל הזמן", "רק בלילה", "רק מרחוק (אפליקציה)", "לסירוגין"]
      }
    ]
  }
];
