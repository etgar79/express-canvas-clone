    ...
    <section className="relative min-h-[700px] flex items-center justify-center overflow-hidden" style={{ 
      ...
      <div className="container px-4 py-24 text-center relative z-10">
        <div className="relative max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 animate-fade-in text-white" style={{
            textShadow: '0 0 40px hsl(190 100% 42% / 0.4), 0 0 80px hsl(260 80% 55% / 0.2)'
          }}>
            תמיכה טכנית חכמה לעסק שלך
          </h1>
          <div className="text-xl md:text-2xl lg:text-3xl mb-12 max-w-4xl mx-auto leading-relaxed text-white/90">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
          <Button
            size="lg"
            className="text-lg px-10 py-7 rounded-full shadow-2xl hover:shadow-primary/50 transition-all duration-300 hover:scale-105 animate-bounce-slow font-bold"
            style={{
              background: 'var(--gradient-button)',
              color: 'white'
            }}
          ...
          <Button
            size="lg"
            variant="outline"
            className="text-lg px-10 py-7 rounded-full border-2 border-primary/50 bg-transparent hover:bg-primary/10 transition-all duration-300 hover:scale-105 text-white font-semibold"
            asChild
          >
            <a href="#contact">
