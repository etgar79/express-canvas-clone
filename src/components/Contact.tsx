          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-6 border border-border bg-card shadow-sm rounded-2xl">
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:info@1979.co.il" className="flex items-center gap-4 p-3 rounded-xl border border-accent/10 hover:border-accent/25 transition-colors bg-accent/5">
                  <div className="p-2 rounded-xl border border-accent/15 bg-accent/10">
                    <Mail className="h-5 w-5 text-accent" />
                  </div>
                  <div>
                    <p className="text-xs text-foreground/40">אימייל</p>
                    <p className="font-semibold text-foreground">שלחו לנו מייל</p>
                  </div>
                </a>
