...
- חשוב מאוד: כשאתה נותן סקריפט מהרשימה, הוסף בסוף ההודעה תגית מוסתרת בפורמט הזה: [SCRIPT_NAME:שם התקלה המדויק מהרשימה]. לדוגמה: [SCRIPT_NAME:מדפסת לא מדפיסה]. זה חייב להיות השם המדויק מהרשימה.
...
- אם הלקוח שואל שאלה כללית על שירותי החברה, ספר שטק תרפי מחשבים מספקים ייעוץ IT, אוטומציה, תמיכה טכנית מרחוק ובמקום, תיקון מחשבים, הקמת רשתות ועוד.`;
